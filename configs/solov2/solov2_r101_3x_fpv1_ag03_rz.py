...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'instances_attributes_train2020_clean_v3.json',
...
log_level = 'INFO'
work_dir = './work_dirs/solo_r101_3x_fpv1_ag03_rz'
load_from = None#'./work_dirs/solo_r101_3x_fpv1_ag03_rz/epoch_6.pth'
resume_from = './work_dirs/solo_r101_3x_fpv1_ag03_rz/epoch_1.pth'
workflow = [('train', 1)]
